...
| 4 | Served-work symptom | `UX-S01..S27`, `WRK-007..013`, `WRK-047`, `WRK-067..086`, `UX-084`, `UX-103..121`, `FED-030..039`, `DAT-045` | partial | exact bounded custom-sprint duration and empty/multi-Domain recovery plus reaction screens for `hard`, `less important`, `other`, and uncertainty under `OPEN-SKIP-001`; vague Description encoding and fear/vague downstream Feed or handoff results remain with their owning flows |
