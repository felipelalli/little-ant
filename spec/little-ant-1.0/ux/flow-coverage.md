...
| 4 | Served-work symptom | `UX-S01..S29`, `WRK-007..013`, `WRK-047`, `WRK-067..088`, `UX-084`, `UX-103..123`, `FED-030..041`, `DAT-045` | partial | exact bounded custom-sprint duration and empty/multi-Domain recovery plus reaction screens for `less important`, `other`, and uncertainty under `OPEN-SKIP-001`; vague Description encoding and downstream Feed or handoff results remain with their owning flows |
