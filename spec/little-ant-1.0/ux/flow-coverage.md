...
| 2 | Revision/stale response | `UX-029..031`, `UX-191..193`, UX-ER02 | specified | concurrency, crash, and integrity-token fixture replay |
...
| 3 | Useful non-pristine empty | `UX-E01`, `FOC-028` | specified | state-derived choice transitions |
| 3 | Feed text input | `FED-049`, `UX-M01`, `UX-I02`, `UX-047..049`, `UX-144`, `UX-184` | specified | deterministic post-commit revalidation, pristine transition, empty-input failure, and crash replay |
...
| 3 | Nature discovery | `UX-K01..K03`, `FED-024..027` | specified | exact full traversal transcript |
