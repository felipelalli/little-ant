...
| 4 | Served-work symptom | `UX-S01..S07`, `WRK-007..013`, `WRK-047`, `WRK-067..068`, `UX-084`, `UX-103`, `FED-030..031` | partial | exact `tired` reaction consequences and reaction screens for the remaining symptoms under `OPEN-SKIP-001` |
