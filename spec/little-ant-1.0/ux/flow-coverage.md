...
| 4 | Served-work symptom | `UX-S01..S45`, `WRK-007..013`, `WRK-047`, `WRK-067..105`, `UX-084`, `UX-103..133`, `UX-152..161`, `FED-030..041`, `IMP-039`, `FOC-047`, `DAT-045` | partial | exact bounded custom-sprint/general-date selection, remaining update-branch screens, and empty/multi-Domain recovery under `OPEN-SKIP-001`; downstream Feed or handoff results remain with their owning flows |
