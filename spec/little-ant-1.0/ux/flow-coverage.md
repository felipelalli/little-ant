...
| 4 | Atomic break/reclassification and part addition | `UX-S06`, `UX-S55..S56`, `UX-B00..B02`, `MOD-045..047`, `MOD-052`, `IMP-030`, `IMP-045`, `FOC-039..040`, `WRK-115`, `UX-057`, `UX-085..089`, `UX-174..176` | partial | deterministic interactive replay, duplicate-suspicion handoff, and exact undo compensation |
...
| 4 | Direct semantic update | `MOD-060..061`, `WRK-101..115`, `UX-154..176`, `UX-S37..S56`, `SCN-ARC-001` | partial | remaining incompatible-Nature, ListEntry, and responsibility Plan routes under `OPEN-PLAN-001`; placement reuses `IMP-004`, `IMP-045`, and `MOD-031`; compensation remains under `OPEN-UNDO-001`; parent-search tie ranking remains under `OPEN-REF-001`; timing, context, and source-material branch screens, remaining uncertainty trees, exact return envelopes, and paired direct/stale/archived replay |
