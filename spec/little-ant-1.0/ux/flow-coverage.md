...
| 4 | Served-work symptom | `UX-S01..S09`, `WRK-007..013`, `WRK-047`, `WRK-067..070`, `UX-084`, `UX-103..105`, `FED-030..031` | partial | exact `tired` pause, zero-candidate/no-target recovery, and multi-Domain source plus reaction screens for the remaining symptoms under `OPEN-SKIP-001` |
