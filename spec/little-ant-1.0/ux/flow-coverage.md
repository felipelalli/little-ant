...
| 4 | Served-work symptom | `UX-S01..S30`, `WRK-007..013`, `WRK-047`, `WRK-067..092`, `UX-084`, `UX-103..126`, `FED-030..041`, `IMP-039`, `FOC-047`, `DAT-045` | partial | exact bounded custom-sprint/general-date selection and empty/multi-Domain recovery plus reaction screens for `other` and uncertainty under `OPEN-SKIP-001`; vague Description encoding and downstream Feed or handoff results remain with their owning flows |
