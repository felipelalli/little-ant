...
| 4 | Served-work symptom | `UX-S01..S17`, `WRK-007..013`, `WRK-047`, `WRK-067..080`, `UX-084`, `UX-103..114`, `FED-030..033`, `DAT-045` | partial | exact bounded custom-sprint duration and empty/multi-Domain recovery plus reaction screens for `vague`, `hard`, `fear`, `less important`, `other`, and uncertainty under `OPEN-SKIP-001` |
