...
| 4 | Served-work symptom | `UX-S01..S23`, `WRK-007..013`, `WRK-047`, `WRK-067..083`, `UX-084`, `UX-103..118`, `FED-030..036`, `DAT-045` | partial | exact bounded custom-sprint duration and empty/multi-Domain recovery plus reaction screens for `vague`, `hard`, `less important`, `other`, and uncertainty under `OPEN-SKIP-001`; fear's downstream handoff results remain with their owning flows |
