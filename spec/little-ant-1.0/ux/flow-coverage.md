...
| 2 | Contextual personality | `UX-F04`, `UX-064..065`, `SCN-014` | partial | review all four 16-phrase English catalogs |
...
| 3 | Restore/startup to `next` | `UX-R00`, `UX-F04`, `UX-046`, `UX-063` | partial | pending-envelope result transition |
...
| 3 | Focus and secondary done | `UX-F01..F04`, `UX-M01`, `WRK-002`, `WRK-005` | partial | `/done` result and next envelope |
