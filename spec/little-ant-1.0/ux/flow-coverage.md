...
| 4 | Direct semantic update | `MOD-060..061`, `WRK-101..114`, `UX-154..171`, `UX-S37..S52`, `SCN-ARC-001` | partial | same-Domain move preview, new-sibling placement, remaining Plan structure managers, and responsibility route under `OPEN-PLAN-001`; parent-search tie ranking under `OPEN-REF-001`; timing, context, and source-material branch screens; uncertainty trees; exact return envelopes; and paired direct/stale/archived replay |
