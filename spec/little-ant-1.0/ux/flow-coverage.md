...
| 4 | Direct semantic update | `MOD-060..061`, `WRK-101..114`, `UX-154..173`, `UX-S37..S54`, `SCN-ARC-001` | partial | remaining Plan structure managers and responsibility route under `OPEN-PLAN-001`; placement reuses `IMP-004` and `MOD-031`; move compensation remains under `OPEN-UNDO-001`; parent-search tie ranking remains under `OPEN-REF-001`; timing, context, and source-material branch screens, remaining uncertainty trees, exact return envelopes, and paired direct/stale/archived replay |
