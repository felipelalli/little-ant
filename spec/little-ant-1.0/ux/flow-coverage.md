...
| 4 | Served-work symptom | `UX-S01..S10`, `WRK-007..013`, `WRK-047`, `WRK-067..071`, `UX-084`, `UX-103..106`, `FED-030..031` | partial | zero-candidate/no-target recovery and multi-Domain source for `tired`, plus reaction screens for the remaining symptoms under `OPEN-SKIP-001` |
