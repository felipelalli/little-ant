...
| 4 | Direct semantic update | `MOD-060..061`, `WRK-101..113`, `UX-154..170`, `UX-S37..S51`, `SCN-ARC-001` | partial | parent selector, same-Domain move preview, new-sibling placement, remaining Plan structure managers, and responsibility route under `OPEN-PLAN-001`; timing, context, and source-material branch screens; uncertainty trees; exact return envelopes; and paired direct/stale/archived replay |
