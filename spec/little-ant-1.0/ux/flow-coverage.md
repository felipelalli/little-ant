...
| 4 | Served-work symptom | `UX-S01..S08`, `WRK-007..013`, `WRK-047`, `WRK-067..069`, `UX-084`, `UX-103..104`, `FED-030..031` | partial | exact `tired` subject-change, pause, and zero-candidate recovery plus reaction screens for the remaining symptoms under `OPEN-SKIP-001` |
