...
| Brick axes, Natures, Templates, ListEntries | `MOD-002..005`, `MOD-013..018`, `MOD-025..063`, `WRK-117..118`, `UX-180..181`, UX-L00..L01 | conceptual sessions and Nature/Template/structure capability, checklist lifecycle, and screen reviews |
...
| Focus, WIP, skip, time, standing work, delegation, semantic maintenance | `WRK-001..118` | v0 behavior audit plus skip, recurrence, habit, delegation, honest-sprint, fear, vague, hard, less-important, other-recovery, honest-answer, direct-update, Plan/structure/parts/move, and checklist-run sessions |
| Canonical interaction and dumb REPL | `UX-001..181`, screen catalog | REPL recovery and screen-by-screen review, including direct semantic update, Plan structure, parent selection, parts, ListEntries, structural compatibility, and Domain contrast |
