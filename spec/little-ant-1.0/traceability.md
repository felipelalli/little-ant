...
| UUIDv7 identity, typed mnemonic `#`/`+`/`@` handles, repeated titles, duplicate suspicion, merge | `MOD-008..012`, `MOD-085..088`, `FED-004`, `FED-015..018`, `WRK-131..133`, `UX-075..076`, `UX-201..203`, `UX-220..223`, UX-LC01..LC03 | v0 audit plus the 1.0 identity, human-reference, merge, and supersession redesign |
| Brick axes, Natures, Templates, ListEntries, Delegation | `MOD-002..007`, `MOD-013..018`, `MOD-025..064`, `MOD-077..082`, `WRK-117..122`, `UX-180..183`, UX-NAT01, UX-L00..L01, UX-D02..D04 | conceptual sessions and Nature/Template/structure capability, all-pairs reclassification, checklist lifecycle, responsibility, and Delegation screen reviews |
...
| Importance and `org-sort-tasks` | `IMP-001..016`, `IMP-030..046` | v0 `Order.hs`/tests, canonical importance correction, regression audit, lower-order recovery, honest-answer comparison, additive-part, and no-nearby-alternative sessions |
| Impact, effort, planning calibration | `IMP-017..029`, `IMP-038`, `IMP-047..056`, `FOC-054`, `UX-224..234`, UX-J00..J08, `DAT-030..037`, calibration profile | estimation/TaskJuggler, tired-recovery, evidence-maturity, exemplar-comparison, and cross-axis contradiction sessions |
...
| Focus, WIP, skip, time, standing work, delegation, semantic maintenance | `WRK-001..145` | v0 behavior audit plus complete served-work recovery, Wait pressure/follow-up, recurrence, habit, standing commands, Delegation lifecycle, bounded sprint and time selection, fear, vague, hard, less-important, other-recovery, honest-answer, direct-update, Plan structure, and checklist-run sessions |
| Canonical interaction and dumb REPL | `UX-001..243`, screen catalog | REPL recovery and screen-by-screen review, including envelopes, typed errors, undo/redo, references, Feed return, atomic Work materialization, direct semantic update, Plan structure, parent selection, parts, ListEntries, responsibility, Delegation, judgment assistance, Wait strategy, standing returns, habit outcomes, structural compatibility, Domain contrast, and complete skip recovery |
| Event authority, sparse output, imports, Packs, Calendar | `DAT-001..056` | context-pollution, source safety, Pack, Calendar, cold-load, sparse-timer, projection, and corrupt-log recovery sessions |
