...
| [25 Natures/templates](history/25-brick-natures-and-template-library.md) | `MOD-004..005`, `MOD-025..028`, `MOD-035..044`, `FED-005..009`, `FED-024..027`, `WRK-031..032`, `UX-056`, `OPEN-SCH-001` | adopted with current terminology corrections; `standing_checklist` superseded by `living_checklist` |
...
| [27 standing work](history/27-standing-work-recurrence-obligations-and-practices.md) | `WRK-019..028`, `WRK-038..040`, `UX-054`, `OPEN-WRK-001..002` | adopted/open; `practice` vocabulary superseded by `habit` |
