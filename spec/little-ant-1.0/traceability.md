...
| Canonical interaction and dumb REPL | `UX-001..277`, screen and personality catalogs | REPL recovery and screen-by-screen review, including envelopes, typed errors, undo/redo, references, Feed return, atomic Work materialization, direct semantic update, Plan structure, parent selection, parts, ListEntries, responsibility, contact delivery, locked credentials, Delegation, judgment assistance, Wait and Place strategy, notices, recurrence, scheduled commitments, external effects, imports, Calendar reconciliation, local-web parity, Pack trust/update/revocation, migration, accessible phase and selection rendering, personality, standing returns, habit outcomes, structural compatibility, Domain contrast, and complete skip recovery |
| Event authority, sparse output, imports, Packs, Calendar, configuration, and credentials | `DAT-001..091`, standard integration catalog, Pack format and trust | context-pollution, source safety, closed effect protocol, verified import/cleanup, release adapter placement, Calendar authority/privacy, local-web boundary, reproducible Pack archive and trust lifecycle, cold-load, sparse-timer, projection, corrupt-log recovery, XDG profile separation, and vault threat review sessions |
