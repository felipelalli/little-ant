...
| Canonical interaction and dumb REPL | `UX-001..272`, screen and personality catalogs | REPL recovery and screen-by-screen review, including envelopes, typed errors, undo/redo, references, Feed return, atomic Work materialization, direct semantic update, Plan structure, parent selection, parts, ListEntries, responsibility, contact delivery, locked credentials, Delegation, judgment assistance, Wait strategy, notices, recurrence, scheduled commitments, external effects, imports, Calendar reconciliation, local-web parity, Pack trust/update/revocation, accessible phase and selection rendering, personality, standing returns, habit outcomes, structural compatibility, Domain contrast, and complete skip recovery |
