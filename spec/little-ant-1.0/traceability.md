...
| Focus, WIP, skip, time, standing work, delegation, semantic maintenance | `WRK-001..128` | v0 behavior audit plus complete served-work recovery, recurrence, habit, Delegation lifecycle, bounded sprint and time selection, fear, vague, hard, less-important, other-recovery, honest-answer, direct-update, Plan structure, and checklist-run sessions |
| Canonical interaction and dumb REPL | `UX-001..217`, screen catalog | REPL recovery and screen-by-screen review, including envelopes, typed errors, undo/redo, references, Feed return, atomic Work materialization, direct semantic update, Plan structure, parent selection, parts, ListEntries, responsibility, Delegation, structural compatibility, Domain contrast, and complete skip recovery |
