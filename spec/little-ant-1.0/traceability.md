...
| Raw, Inbox, lazy triage, Description, same-Raw normalization, shelves, sources | `MOD-001`, `MOD-023`, `MOD-029`, `MOD-049`, `MOD-054`, `FED-001..018`, `FED-042..051`, `FOC-051..052`, `UX-144..150`, `UX-184..185`, `DAT-002`, `DAT-011..017`, `DAT-042..043`, `OPEN-RAW-*` | `98dbe1c`, explicit post-`9a748bf` correction, `33e9dd3`, Raw-first Feed and atomic materialization UX reviews |
...
| Canonical interaction and dumb REPL | `UX-001..185`, screen catalog | REPL recovery and screen-by-screen review, including Feed return, atomic Work materialization, direct semantic update, Plan structure, parent selection, parts, ListEntries, responsibility, Delegation, structural compatibility, and Domain contrast |
