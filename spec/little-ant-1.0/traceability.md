...
| UUIDv7 identity, typed mnemonic `#`/`+`/`@` handles, repeated titles, duplicate suspicion, merge | `MOD-008..012`, `FED-004`, `FED-015..018`, `UX-075..076`, `UX-201..203`, `OPEN-MERGE-001` | v0 audit plus the 1.0 identity and human-reference redesign |
...
| Composition, sibling locality, Domains, dependencies | `MOD-019..024`, `MOD-031..034`, `MOD-060..061`, `MOD-073..076`, `FED-030..041`, `FED-057..058`, `FOC-055..060`, `UX-205..209`, `OPEN-TREE-001` | hierarchy, direct-Domain, forest/scope, move-preview, and enabling-recovery sessions including fear, vague, and hard recovery |
...
| Focus, WIP, skip, time, standing work, delegation, semantic maintenance | `WRK-001..121` | v0 behavior audit plus skip, recurrence, habit, Delegation lifecycle, honest-sprint, fear, vague, hard, less-important, other-recovery, honest-answer, direct-update, Plan structure, and checklist-run sessions |
| Canonical interaction and dumb REPL | `UX-001..204`, screen catalog | REPL recovery and screen-by-screen review, including envelopes, typed errors, undo/redo, references, Feed return, atomic Work materialization, direct semantic update, Plan structure, parent selection, parts, ListEntries, responsibility, Delegation, structural compatibility, and Domain contrast |
