...
| Forecast, hierarchy, Domain and interaction-family continuity, blockers, and opportunity variants | `FOC-001..045` | recovery ledger decisions and fixed-stream UX scenarios |
| Focus, WIP, skip, time, standing work, delegation | `WRK-001..071` | v0 behavior audit plus skip, recurrence, habit, and delegation sessions |
| Canonical interaction and dumb REPL | `UX-001..106`, screen catalog | REPL recovery and screen-by-screen review |
