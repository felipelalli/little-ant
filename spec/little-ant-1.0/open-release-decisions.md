...
| `OPEN-WRK-001` | Final public commands for pausing or clearing focus, WIP-to-idle, standing-run finish, and retiring standing work. Transactional `/next` browsing is already settled by `FOC-033` and `UX-066`. | Focus, interruption, checklist, and repeatable-work screens. |
