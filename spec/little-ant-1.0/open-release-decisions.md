...
| `OPEN-WAIT-001` | Exact first-review and repeated-review policy for Wait: dumb choices, factory default, assisted suggestion boundary, pressure growth, overdue behavior, source-observed candidate resolution, and follow-up cadence. Wait identity, non-focusability, subject-ticket review, request handoff, and review outcome families are settled by `MOD-050`, `FOC-034`, and `WRK-050..054`. | Request-already-made, enabling handoff, short/long human response, source-observed response, repeated no-response, follow-up, reclassification, and resolution simulations. |
...
| `OPEN-REF-001` | The minimum seven-character lowercase-hex short form, collision-driven expansion, Brick `#` sigil, and ExternalEntity `@` sigil are settled by `MOD-008..010`. Remaining work: full opaque-ID encoding, explicit references for Raw and other technical records, pasted-reference/action-token precedence, cross-dataset ambiguity, and exact recovery screens. | Repeated-title, short-prefix collision, stale-title, Raw/technical-reference, and cross-surface selection simulations. |
