...
| `OPEN-EXT-002` | Which listed importers and UIAdapters ship inside the offline standard Pack versus the pinned companion catalog. | API feasibility and release packaging review; all listed sources remain supported 1.0 targets. |
