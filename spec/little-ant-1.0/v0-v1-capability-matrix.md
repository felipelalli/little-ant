...
| Break creates independently tracked children | `I+T` | **strengthened** | explicit or evidence-backed recovery, pending dumb/assisted part collection, existing-part inspection and addition, reviewable Nature defaults, provisional run seeding, human-facing atomic preview, stable result, and Nature settlement under `MOD-019..021`, `MOD-045..047`, `MOD-052..053`, `IMP-030`, `IMP-045`, `FOC-039..040`, `WRK-067`, `WRK-115`, `UX-085..090`, `UX-174..176`, `UX-S06`, `UX-S55..S56`, `UX-B00..B02`, `UX-N01` | atomic-break and additive-part routes |
| Kind or behavior can be edited as loosely coupled fields | `I+T` | **replaced and constrained** | behavior means exactly one Nature; timing and plan retain their own routes; Template is immutable creation provenance; reclassification preserves truth and requires typed reconciliation under `MOD-058..059`, `WRK-106..107`, and UX-S46..S47 | complete `OPEN-NAT-001` capability-delta table, generated transition matrix, and paired behavior-update replay |
...
| `vague` regresses lifecycle and may create a clarification meta-Brick | `I+T` | **retired** | direct goal clarification revises the Raw attached as description under `FED-037`, `WRK-085`, and UX-S24..S26; missing context or first-step discovery uses explicit enabling work under `FED-038` and `WRK-086`, without stage regression | vague reaction route plus `OPEN-RAW-001` encoding scenario |
