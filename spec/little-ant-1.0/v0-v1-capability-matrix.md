...
| Human evidence outranks AI pre-ordering | `I+T` | **strengthened** | temporal and provenance-aware evidence under `IMP-011..015`, `IMP-033..036` | assisted insertion, stale reversal, bounded fresh-cycle resolution, and unresolved confidence |
| Adjacent question rounds, stale comparisons, and burst/time sanity triggers | `I+T`, `Order.hs`, `Tick.hs` | **replaced** | derived review opportunities, not meta-Bricks, under `IMP-014..016`, `IMP-033..036`, `FOC-009`, `FOC-042..043` | ordering maintenance, provocative validation, and segment recalibration routes |
...
| Cycles are silently broken by creation order | `I+T` | **retired** | confidence-sensitive contradiction, bounded iterative fresh-cycle resolution, preserved history, and unresolved local review under `IMP-013..015`, `IMP-033..036`, `UX-097..101` | `SCN-IMP-003` |
