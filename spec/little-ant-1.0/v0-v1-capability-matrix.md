...
| V0 capability | Evidence | 1.0 disposition | Canonical destination | Acceptance route |
|---|---|---|---|---|
| Every served skip records a typed reason and optional verbatim text | `I+T` | **strengthened** | symptom then reaction under `WRK-007..013`, `WRK-047`, `WRK-067..088`, `UX-S01`, `UX-S06..S29`; `tired`, `bored`, `fear`, `vague`, and `hard` have explicit recovery routes including positive subject targets, organization work, visible decomposition, better-method enablers, an honest short-sprint timebox, validation, safer prerequisites, typed human support, content-versus-work clarification, and learning or practice | one route per symptom family |
