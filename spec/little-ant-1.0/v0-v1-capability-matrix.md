...
| Break creates independently tracked children | `I+T` | **strengthened** | explicit or evidence-backed recovery, pending dumb/assisted part collection, reviewable Nature defaults, provisional run seeding, human-facing atomic preview, stable result, and Nature settlement under `MOD-019..021`, `MOD-045..047`, `MOD-052..053`, `IMP-030`, `FOC-040`, `WRK-067`, `UX-085..090`, `UX-S06`, `UX-B00..B02`, `UX-N01` | atomic-break route |
...
| V0 capability | Evidence | 1.0 disposition | Canonical destination | Acceptance route |
|---|---|---|---|---|
| Every served skip records a typed reason and optional verbatim text | `I+T` | **strengthened** | symptom then reaction under `WRK-007..013`, `WRK-047`, `WRK-067..094`, `UX-S01`, `UX-S06..S32`; all named symptoms now have explicit dumb recovery or confirmed defer-only routes, including positive subject targets, organization work, visible decomposition, better-method enablers, an honest short-sprint timebox, validation, safer prerequisites, typed human support, content-versus-work clarification, learning or practice, comparison-backed reordering, dated eligibility, and verbatim other evidence | one route per symptom family |
...
| `vague` regresses lifecycle and may create a clarification meta-Brick | `I+T` | **retired** | direct goal clarification changes Description Raw under `FED-037`, `WRK-085`, and UX-S24..S26; missing context or first-step discovery uses explicit enabling work under `FED-038` and `WRK-086`, without stage regression | vague reaction route plus `OPEN-RAW-001` encoding scenario |
