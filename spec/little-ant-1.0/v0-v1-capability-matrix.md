...
| Break creates independently tracked children | `I+T` | **strengthened** | explicit or evidence-backed recovery, pending dumb/assisted part collection, reviewable Nature defaults, provisional run seeding, and atomic preview under `MOD-019..021`, `MOD-045..047`, `MOD-052`, `IMP-030`, `WRK-067`, `UX-085..087`, `UX-S06`, `UX-B00..B01` | atomic-break route |
