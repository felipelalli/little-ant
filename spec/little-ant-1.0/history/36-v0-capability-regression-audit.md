...
| Delegation has draft/notice approval, cancellation before notice, due follow-ups, approve/decline nudge, and terminal completed/refused/abandoned outcomes. | **partly restore / review lifecycle** | Every Delegation requires one-time, repeating, or explicit-none follow-up policy; repeating schedules approval-bearing opportunities only. Scope is Nature-aware through `brick_only`, `whole_scope`, `ask`, or `disabled`. Compact statuses, outcome names, and effect flow remain under review. |
